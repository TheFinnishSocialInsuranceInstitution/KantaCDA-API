...
public class ReseptinKorjausKasaaja extends ReseptiKasaaja {
    ...
    protected void paivataKorjaus() {
        ...
        if(null == korjaus.isAnnostusTarvittaessa()) {
        	korjaus.setAnnostusTarvittaessa(alkuperainenLaakemaarays.isAnnostusTarvittaessa());
        }
		if (null == korjaus.getAnnosajaksonPituus()) {
			korjaus.setAnnosajaksonPituus(alkuperainenLaakemaarays.getAnnosajaksonPituus());
		}
		if (korjaus.getAnnokset().isEmpty()) {
			korjaus.getAnnokset().addAll(alkuperainenLaakemaarays.getAnnokset());
		}
