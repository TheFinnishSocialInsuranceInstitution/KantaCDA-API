...
public class ReseptinMitatointiKasaajaEteenpainYht extends ReseptiKasaaja {
    ...
    private void paivitaMitatointi() {
        ...
        if (null == mitatointi.isAnnostusTarvittaessa()) {
        	mitatointi.setAnnostusTarvittaessa(alkuperainenLaakemaarays.isAnnostusTarvittaessa());
        }
		if (null == mitatointi.getAnnosajaksonPituus()) {
			mitatointi.setAnnosajaksonPituus(alkuperainenLaakemaarays.getAnnosajaksonPituus());
		}
		if (mitatointi.getAnnokset().isEmpty()) {
			mitatointi.getAnnokset().addAll(alkuperainenLaakemaarays.getAnnokset());
		}
