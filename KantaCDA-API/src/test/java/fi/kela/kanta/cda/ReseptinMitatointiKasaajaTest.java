...
public class ReseptinMitatointiKasaajaTest extends LMTOKasaaja {
    ...
    private void setupLaakemaarayksenLeimakentat(LaakemaaraysTO laakemaaraysTO) {
        laakemaaraysTO.setOid(ReseptinMitatointiKasaajaTest.testAlkuperainenOid);
        // laakemaaraysTO.setOrgYTunnus("1234567-8");
        laakemaaraysTO.setSetId(ReseptinMitatointiKasaajaTest.testAlkuperainenSetId);
        laakemaaraysTO.setVersio(ReseptinMitatointiKasaajaTest.testAlkuperainenVersio);
        laakemaaraysTO.setCdaTyyppi(ReseptinMitatointiKasaajaTest.testAlkuperainenCdaTyyppi);
    }
    ...
    public void testPaivataMitatointi_leimatiedot() throws Exception {
        ...
        ReseptinMitatointiKasaaja tested = setupReseptinMitatointiKasaaja(laakemaarayksenMitatointiTO, laakemaaraysTO);
        Whitebox.invokeMethod(tested, "paivitaMitatointi", laakemaarayksenMitatointiTO, laakemaaraysTO);
        ...
        Assert.assertEquals("mitatoinnin alkuperainenOid pitää olla alkuperaienenOid",
                ReseptinMitatointiKasaajaTest.testAlkuperainenOid, laakemaarayksenMitatointiTO.getAlkuperainenOid());
        Assert.assertEquals("mitatoinnin alkuperainenCdaTyyppi pitää olla alkuperainenCdaTyyppi",
                ReseptinMitatointiKasaajaTest.testAlkuperainenCdaTyyppi,
                laakemaarayksenMitatointiTO.getAlkuperainenCdaTyyppi());
        Assert.assertEquals("mitatoinnin setId pitää olla alkuperainenSetId",
                ReseptinMitatointiKasaajaTest.testAlkuperainenSetId, laakemaarayksenMitatointiTO.getSetId());
        Assert.assertEquals("mitatoinnin versio pitää olla alkuperainenVersio",
                ReseptinMitatointiKasaajaTest.testAlkuperainenVersio, laakemaarayksenMitatointiTO.getVersio());
    }
    ...
    public void testPaivataMitatointi_arvot() throws Exception {
        ...
        laakemaaraysTO.setApteekissaTallennettuLaakemaarays("1");
    ...
    public void testGetPropertyCode() throws Exception {
        ReseptinMitatointiKasaaja tested = setupReseptinMitatointiKasaaja(null, null);
    ...
    public void testLuoViittaukset() throws Exception {
        ...
        String mitatoinninSetId = ReseptinMitatointiKasaajaTest.testAlkuperainenSetId;
        laakemaarayksenMitatointiTO.setOid(mitatoinninnOid);
        laakemaarayksenMitatointiTO.setSetId(mitatoinninSetId);
        laakemaarayksenMitatointiTO.setAlkuperainenOid(ReseptinMitatointiKasaajaTest.testAlkuperainenOid);
        ReseptinMitatointiKasaaja tested = setupReseptinMitatointiKasaaja(laakemaarayksenMitatointiTO, null);
        ...
        for (POCDMT000040Reference viittaus : viittaukset) {
            if ( viittaus.getTypeCode() == XActRelationshipExternalReference.SPRT ) {
                ...
                tarkistaViittaus(viittaus, ReseptinMitatointiKasaajaTest.testAlkuperainenOid, mitatoinninSetId, "1");
            }
        }
    ...
    public void testLuoKorjauksenSyyPerusteluJaKorjaaja() throws Exception {
        ...
        LaakemaarayksenMitatointiTO laakemaarayksenMitatointiTO = new LaakemaarayksenMitatointiTO();
        tested = setupReseptinMitatointiKasaaja(laakemaarayksenMitatointiTO, null);
