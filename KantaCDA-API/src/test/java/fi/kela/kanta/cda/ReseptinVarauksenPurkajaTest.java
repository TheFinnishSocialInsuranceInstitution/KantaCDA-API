...
public class ReseptinVarauksenPurkajaTest {
    ...
    public void testPuraRelatedDocument() throws Exception {
        ...
        LaakemaarayksenVarausTO to = new LaakemaarayksenVarausTO();
    ...
    public void testPuraLukituksenSelitys() throws Exception {
        ...
        Whitebox.invokeMethod(purkaja, "puraVarauksenSelitys", cda, to);
